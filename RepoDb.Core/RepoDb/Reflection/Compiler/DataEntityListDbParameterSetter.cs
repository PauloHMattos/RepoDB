...
namespace RepoDb.Reflection
{
    internal partial class Compiler
    {
        ...
        /// <returns></returns>
        internal static Action<DbCommand, IList<T>> CompileDataEntityListDbParameterSetter<T>(Type entityType,
            ...
            IDbHelper dbHelper)
        {
            ...
            return Expression
                .Lambda<Action<DbCommand, IList<T>>>(Expression.Block(bodyExpressions), dbCommandExpression, entitiesParameterExpression)
                .Compile();
        }
    }
}
