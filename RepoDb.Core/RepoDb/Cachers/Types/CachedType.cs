...
public class CachedType
{
    ...
    private readonly Lazy<bool> lazyIsEntityType;
    ...
    public CachedType(Type type)
    {
        ...
        lazyIsEntityType = new Lazy<bool>(() => type.IsClassType() || type.IsNonPrimitiveValueType());
    ...
    public bool IsEntityType() => lazyIsEntityType.Value;
