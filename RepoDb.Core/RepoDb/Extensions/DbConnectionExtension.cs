    ...
    public static partial class DbConnectionExtension
    {
            ...
            IDbTransaction transaction)
        {
            ...
            if (queryGroup == null)
            {
                ...
                if (cachedType.IsClassType() || cachedType.IsAnonymousType() || cachedType.IsNonPrimitiveValueType())
                {
            ...
            where TEntity : class
        {
            ...
            var cachedType = TypeCache.Get(typeOfEntity);
            return (cachedType.IsClassType() || cachedType.IsNonPrimitiveValueType()) == false 
                ? Field.Parse(entity) : FieldCache.Get(typeOfEntity);
        }
